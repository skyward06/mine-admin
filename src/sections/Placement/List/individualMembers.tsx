...
export default function IndividualMembers({ open, onMinerChange }: Props) {
  const router = useRouter();

  const { loading, members, fetchIndividualMembers } = useFetchIndividualMembers();
