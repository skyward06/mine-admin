...
import { useFetchSponsors } from 'src/sections/Placement/List/useApollo';
...
function PlacementListView() {
  ...
  const { fetchSponsors, members, loading, called } = useFetchSponsors();
  ...
  }, [fetchSponsors, exSetVisibleMap, fitView]);
