...
export const Schema = zod.object({
  ...
  sponsorBonusPackageId: zod.string({ required_error: 'Sponsor Package is required' }),
  rollSponsorBonusPackageId: zod.string({ required_error: 'Roll Sponsor Package is required' }),
