...
export type Member = {
  ...
  updatedAt?: Maybe<Scalars['DateTimeISO']['output']>;
  username: Scalars['String']['output'];
  weeklyCommissionStatuses?: Maybe<Array<Maybe<WeeklyCommissionStatus>>>;
...
export type Query = {
  ...
  weeklyCommissionStatuses: WeeklyCommissionStatusResponse;
...
export type QueryWeeklyCommissionStatusesArgs = {
  filter?: InputMaybe<Scalars['JSONObject']['input']>;
  page?: InputMaybe<Scalars['String']['input']>;
  sort?: InputMaybe<Scalars['String']['input']>;
};
...
export type WeeklyCommission = {
  ...
  deletedAt?: Maybe<Scalars['DateTimeISO']['output']>;
  id: Scalars['ID']['output'];
  leftPoint: Scalars['Float']['output'];
  member?: Maybe<Member>;
  memberId: Scalars['ID']['output'];
  rightPoint: Scalars['Float']['output'];
  status: Confirmation4Status;
  updatedAt?: Maybe<Scalars['DateTimeISO']['output']>;
  weekStartDate: Scalars['DateTimeISO']['output'];
  weeklyCommissionStatus?: Maybe<WeeklyCommissionStatus>;
};
...
export type WeeklyCommissionStatus = {
  __typename?: 'WeeklyCommissionStatus';
  ...
  updatedAt?: Maybe<Scalars['DateTimeISO']['output']>;
  weekStartDate: Scalars['DateTimeISO']['output'];
  weeklyCommission?: Maybe<WeeklyCommission>;
  weeklyCommissionId?: Maybe<Scalars['ID']['output']>;
};

export type WeeklyCommissionStatusResponse = {
  __typename?: 'WeeklyCommissionStatusResponse';
  total?: Maybe<Scalars['Int']['output']>;
  weeklyCommissionStatuses?: Maybe<Array<Maybe<WeeklyCommissionStatus>>>;
};

export type WeeklyCommissionUpdateInput = {
  calculatedLeftPoint?: InputMaybe<Scalars['Float']['input']>;
  calculatedRightPoint?: InputMaybe<Scalars['Float']['input']>;
...
export type WeeklyCommissionsQuery = { __typename?: 'Query', weeklyCommissions: { __typename?: 'WeeklyCommissionResponse', total?: number | null, weeklyCommissions?: Array<{ __typename?: 'WeeklyCommission', id: string, memberId: string, weekStartDate: any, leftPoint: number, rightPoint: number, calculatedLeftPoint: number, calculatedRightPoint: number, commission: number, status: Confirmation4Status, createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, member?: { __typename?: 'Member', createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, id: string, username: string, fullName: string, sponsorId?: string | null, email: string, mobile: string, assetId: string, primaryAddress: string, secondaryAddress?: string | null, city?: string | null, state?: string | null, zipCode?: string | null, placementParentId?: string | null, placementPosition?: PlacementPosition | null, point: number, emailVerified: boolean, status: boolean, totalIntroducers: number } | null, weeklyCommissionStatus?: { __typename?: 'WeeklyCommissionStatus', createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, id: string, weeklyCommissionId?: string | null, beforeLeftPoint: number, beforeRightPoint: number, afterLeftPoint: number, afterRightPoint: number, memberId: string, weekStartDate: any } | null } | null> | null } };

export type WeeklyCommissionStatusesQueryVariables = Exact<{
  sort?: InputMaybe<Scalars['String']['input']>;
  page?: InputMaybe<Scalars['String']['input']>;
  filter?: InputMaybe<Scalars['JSONObject']['input']>;
}>;
...
export type WeeklyCommissionStatusesQuery = { __typename?: 'Query', weeklyCommissionStatuses: { __typename?: 'WeeklyCommissionStatusResponse', total?: number | null, weeklyCommissionStatuses?: Array<{ __typename?: 'WeeklyCommissionStatus', createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, id: string, weeklyCommissionId?: string | null, beforeLeftPoint: number, beforeRightPoint: number, afterLeftPoint: number, afterRightPoint: number, memberId: string, weekStartDate: any, member?: { __typename?: 'Member', createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, id: string, username: string, fullName: string, sponsorId?: string | null, email: string, mobile: string, assetId: string, primaryAddress: string, secondaryAddress?: string | null, city?: string | null, state?: string | null, zipCode?: string | null, placementParentId?: string | null, placementPosition?: PlacementPosition | null, point: number, emailVerified: boolean, status: boolean, totalIntroducers: number } | null, weeklyCommission?: { __typename?: 'WeeklyCommission', createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, id: string, memberId: string, weekStartDate: any, leftPoint: number, rightPoint: number, calculatedLeftPoint: number, calculatedRightPoint: number, commission: number, status: Confirmation4Status } | null } | null> | null } };
...
export type FetchMembersQuery = { __typename?: 'Query', members: { __typename?: 'MembersResponse', total?: number | null, members?: Array<{ __typename?: 'Member', id: string, username: string, fullName: string, email: string, primaryAddress: string, secondaryAddress?: string | null, assetId: string, mobile: string, city?: string | null, state?: string | null, zipCode?: string | null, point: number, sponsorId?: string | null, status: boolean, emailVerified: boolean, totalIntroducers: number, placementParentId?: string | null, placementPosition?: PlacementPosition | null, createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, sponsor?: { __typename?: 'Member', id: string, username: string, fullName: string, email: string, point: number, primaryAddress: string, secondaryAddress?: string | null, mobile: string, assetId: string, status: boolean, emailVerified: boolean, totalIntroducers: number } | null, placementParent?: { __typename?: 'Member', id: string, username: string, fullName: string, email: string, point: number, primaryAddress: string, secondaryAddress?: string | null, mobile: string, assetId: string, status: boolean, emailVerified: boolean, totalIntroducers: number } | null, sales?: Array<{ __typename?: 'Sale', id: string, invoiceNo: number, memberId: string, packageId: string, paymentMethod: string, status: boolean, orderedAt: any } | null> | null, memberWallets?: Array<{ __typename?: 'MemberWallet', createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, id: string, memberId: string, payoutId: string, address: string, percent: number, payout?: { __typename?: 'Payout', id: string, method: string, status: boolean, name: string, display: string, createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null } | null } | null> | null, logs?: Array<{ __typename?: 'MemberLog', id: string, who: string, role: string, when: any, entity: string, action: string, status: string, before?: any | null, after?: any | null } | null> | null } | null> | null } };
...
export type UpdateMemberMutation = { __typename?: 'Mutation', updateMember: { __typename?: 'Member', id: string, mobile: string, primaryAddress: string, secondaryAddress?: string | null, assetId: string } };
...
export type PackagesQuery = { __typename?: 'Query', packages: { __typename?: 'PackageResponse', total?: number | null, packages?: Array<{ __typename?: 'Package', createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, id: string, productName: string, amount: number, status: boolean, date: any, point: number, token: number, sales?: Array<{ __typename?: 'Sale', id: string, invoiceNo: number, memberId: string, orderedAt: any, packageId: string, paymentMethod: string, status: boolean } | null> | null } | null> | null } };
...
export type FetchSalesQuery = { __typename?: 'Query', sales: { __typename?: 'SalesResponse', total?: number | null, sales?: Array<{ __typename?: 'Sale', id: string, invoiceNo: number, memberId: string, packageId: string, paymentMethod: string, orderedAt: any, status: boolean, member?: { __typename?: 'Member', id: string, username: string, fullName: string, email: string, point: number, mobile: string, assetId: string, primaryAddress: string, secondaryAddress?: string | null, status: boolean, emailVerified: boolean, totalIntroducers: number } | null, package?: { __typename?: 'Package', id: string, productName: string, amount: number, date: any, token: number, status: boolean, point: number } | null, statisticsSales?: Array<{ __typename?: 'StatisticsSale', id: string, saleId: string, statisticsId: string, issuedAt: any } | null> | null } | null> | null } };
