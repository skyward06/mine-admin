...
export type FetchMembersQuery = { __typename?: 'Query', members: { __typename?: 'MembersResponse', total?: number | null, members?: Array<{ __typename?: 'Member', id: string, username: string, fullName: string, email: string, primaryAddress: string, secondaryAddress?: string | null, assetId: string, mobile: string, payoutId: string, sponsorId?: string | null, wallet: string, createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, sponsor?: { __typename?: 'Member', id: string, username: string, fullName: string, email: string, primaryAddress: string, secondaryAddress?: string | null, mobile: string, wallet: string, assetId: string, payoutId: string } | null, payout?: { __typename?: 'Payout', id: string, name: string, status: boolean, method: string, display: string } | null, sales?: Array<{ __typename?: 'Sale', id: string, invoiceNo: number, memberId: string, packageId: string, paymentMethod: string, status: boolean, orderedAt: any } | null> | null } | null> | null } };
...
export type CreateMemberMutation = { __typename?: 'Mutation', createMember: { __typename?: 'Member', username: string, fullName: string, email: string, mobile: string, primaryAddress: string, secondaryAddress?: string | null, assetId: string, wallet: string, payoutId: string } };
...
export type FetchMemberQuery = { __typename?: 'Query', members: { __typename?: 'MembersResponse', members?: Array<{ __typename?: 'Member', id: string, username: string, fullName: string, email: string, mobile: string, primaryAddress: string, secondaryAddress?: string | null, assetId: string, wallet: string, payoutId: string, sponsorId?: string | null, deletedAt?: any | null, payout?: { __typename?: 'Payout', id: string, name: string, status: boolean, method: string, display: string } | null, sponsor?: { __typename?: 'Member', id: string, username: string, fullName: string, email: string, primaryAddress: string, secondaryAddress?: string | null, mobile: string, wallet: string, assetId: string, payoutId: string } | null } | null> | null } };
