...
export type Member = {
  ...
  createdAt?: Maybe<Scalars['DateTimeISO']['output']>;
  currentL: Scalars['Int']['output'];
  currentR: Scalars['Int']['output'];
  deletedAt?: Maybe<Scalars['DateTimeISO']['output']>;
  email: Scalars['String']['output'];
