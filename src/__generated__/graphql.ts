...
export type FetchMeQuery = { __typename?: 'Query', adminMe: { __typename?: 'Admin', id: string, email: string, avatar: string, roleId: string, status: AdminStatus, username: string, fullName: string, OTPEnabled: boolean, role?: { __typename?: 'Role', id: string, name: string, sale: number, role: number, commission: number, description: string } | null } };
...
export type FetchUsersQuery = { __typename?: 'Query', admins: { __typename?: 'AdminsResponse', total?: number | null, admins?: Array<{ __typename?: 'Admin', id: string, email: string, avatar: string, roleId: string, status: AdminStatus, username: string, fullName: string, createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, OTPEnabled: boolean, role?: { __typename?: 'Role', id: string, name: string, role: number, sale: number, commission: number, description: string } | null }> | null } };
