...
export type BugReportsQuery = { __typename?: 'Query', bugReports: { __typename?: 'BugReportResponse', total?: number | null, bugReports?: Array<{ __typename?: 'BugReport', id: string, status: BugReportStatus, subject: string, description: string, createdAt?: any | null, files?: Array<{ __typename?: 'PFile', id: string, url: string, size: number, mimeType: string, originalName: string }> | null }> | null } };
...
export type BugReportByIdQuery = { __typename?: 'Query', bugReportById: { __typename?: 'BugReport', createdAt?: any | null, id: string, status: BugReportStatus, subject: string, description: string, solvedBy?: { __typename?: 'Admin', username: string, fullName: string } | null, files?: Array<{ __typename?: 'PFile', id: string, url: string, size: number, mimeType: string, originalName: string }> | null } };
