...
export type MakePrimaryFreeShareMutationVariables = Exact<{
  data: IdInput;
}>;


export type MakePrimaryFreeShareMutation = { __typename?: 'Mutation', makePrimaryFreeShare: { __typename?: 'Package', id: string, primaryFreeShare: boolean } };
...
export const MakePrimaryFreeShareDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"MakePrimaryFreeShare"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"data"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"IDInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"makePrimaryFreeShare"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"data"},"value":{"kind":"Variable","name":{"kind":"Name","value":"data"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"primaryFreeShare"}}]}}]}}]} as unknown as DocumentNode<MakePrimaryFreeShareMutation, MakePrimaryFreeShareMutationVariables>;
