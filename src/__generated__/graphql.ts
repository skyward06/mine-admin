...
export type MemberDailyReward = {
  __typename?: 'MemberDailyReward';
  hashPower: Scalars['Float']['output'];
  issuedAt: Scalars['DateTimeISO']['output'];
  txcShared: Scalars['Float']['output'];
};

export type MemberDailyRewardsInput = {
...
export type Query = {
  ...
  me: User;
  memberDailyReward: Array<MemberDailyReward>;
...
export type QueryMemberDailyRewardArgs = {
  data: MemberDailyRewardsInput;
};
...
export type UpdateSaleInput = {
  hashPower?: InputMaybe<Scalars['Float']['input']>;
  id: Scalars['ID']['input'];
...
export type MemberDailyRewardQueryVariables = Exact<{
  data: MemberDailyRewardsInput;
}>;


export type MemberDailyRewardQuery = { __typename?: 'Query', memberDailyReward: Array<{ __typename?: 'MemberDailyReward', hashPower: number, issuedAt: any, txcShared: number }> };
...
export type CreateSaleMutation = { __typename?: 'Mutation', createSale: { __typename?: 'Sale', invoiceNo: number, hashPower: number, orderedAt: any, memberId: string, paymentMethod: string, packageId: string, status: boolean } };
...
export const MemberDailyRewardDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"MemberDailyReward"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"data"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"MemberDailyRewardsInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"memberDailyReward"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"data"},"value":{"kind":"Variable","name":{"kind":"Name","value":"data"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hashPower"}},{"kind":"Field","name":{"kind":"Name","value":"issuedAt"}},{"kind":"Field","name":{"kind":"Name","value":"txcShared"}}]}}]}}]} as unknown as DocumentNode<MemberDailyRewardQuery, MemberDailyRewardQueryVariables>;
