...
export type FetchSalesQuery = { __typename?: 'Query', sales: { __typename?: 'SalesResponse', total?: number | null, sales?: Array<{ __typename?: 'Sale', id: string, ID: number, note?: string | null, memberId: string, packageId: string, createdAt?: any | null, updatedAt?: any | null, status: boolean, orderedAt: any, paymentMethod: string, reflinks?: Array<{ __typename?: 'RefLink', linkType: string, link: string } | null> | null, member?: { __typename?: 'Member', id: string, ID: number, email: string, point: number, mobile: string, status: boolean, assetId?: string | null, begL: number, begR: number, newL: number, newR: number, username: string, fullName: string, syncWithSendy: boolean, emailVerified: boolean, primaryAddress: string, secondaryAddress?: string | null, totalIntroducers: number, preferredContact?: string | null, preferredContactDetail?: string | null, createdAt?: any | null } | null, package?: { __typename?: 'Package', id: string, date: any, token: number, point: number, amount: number, status: boolean, productName: string, enrollVisibility: boolean } | null, statisticsSales?: Array<{ __typename?: 'StatisticsSale', id: string, saleId: string, issuedAt: any, statisticsId: string } | null> | null, paymentConfirm?: Array<{ __typename?: 'PFile', id: string, url: string, originalName: string, mimeType: string, size: number, createdAt?: any | null, updatedAt?: any | null } | null> | null } | null> | null } };
