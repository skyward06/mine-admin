...
export type SaleBySidQuery = { __typename?: 'Query', saleBySID: { __typename?: 'Sale', id: string, ID: number, status: boolean, vendor?: string | null, isMetal: boolean, memberId: string, orderedAt: any, packageId: string, createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, sponsorCnt: number, toMemberId?: string | null, paymentMethod: string, statisticsSales?: Array<{ __typename?: 'StatisticsSale', id: string, saleId: string, issuedAt: any, statisticsId: string }> | null, package?: { __typename?: 'Package', id: string, date: any, token: number, point: number, amount: number, status: boolean, freeShare: boolean, productName: string, enrollVisibility: boolean } | null, proof?: { __typename?: 'Proof', id: string, note?: string | null, type: ProofType, refId: string, amount: number, orderedAt: any, files?: Array<{ __typename?: 'PFile', id: string, url: string, size: number, mimeType: string, originalName: string }> | null, reflinks?: Array<{ __typename?: 'RefLink', link: string, linkType: string }> | null } | null, member?: { __typename?: 'Member', id: string, ID?: number | null, email: string, point: number, mobile: string, status: boolean, assetId?: string | null, balance: number, username: string, fullName: string, groupName: string, createdAt?: any | null, allowState: MemberState, teamReport: Array<TeamReport>, OTPEnabled: boolean, teamStrategy: TeamStrategy, syncWithSendy: boolean, emailVerified: boolean, primaryAddress: string, secondaryAddress?: string | null, totalIntroducers: number, preferredContact?: string | null, placementPosition: PlacementPosition, commissionDefault: CommissionDefaultEnum, cmnCalculatedWeeks: number, preferredContactDetail?: string | null, commission?: { __typename?: 'CommissionStatus', begL: number, begR: number, newL: number, newR: number } | null } | null, toMember?: { __typename?: 'Member', id: string, ID?: number | null, email: string, point: number, mobile: string, status: boolean, assetId?: string | null, balance: number, username: string, fullName: string, groupName: string, createdAt?: any | null, allowState: MemberState, teamReport: Array<TeamReport>, OTPEnabled: boolean, teamStrategy: TeamStrategy, syncWithSendy: boolean, emailVerified: boolean, primaryAddress: string, secondaryAddress?: string | null, totalIntroducers: number, preferredContact?: string | null, placementPosition: PlacementPosition, commissionDefault: CommissionDefaultEnum, cmnCalculatedWeeks: number, preferredContactDetail?: string | null, commission?: { __typename?: 'CommissionStatus', begL: number, begR: number, newL: number, newR: number } | null } | null, frontActions?: Array<(
      { __typename?: 'FrontAction' }
      & { ' $fragmentRefs'?: { 'FrontActionFieldsFragment': FrontActionFieldsFragment } }
    )> | null } };
