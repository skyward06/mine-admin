...
export type MembersQuery = { __typename?: 'Query', members: { __typename?: 'BasicMemberResponse', total?: number | null, members?: Array<{ __typename?: 'BasicMember', id: string, ID?: number | null, email: string, status: boolean, mobile: string, assetId?: string | null, username: string, fullName: string, createdAt: any, allowState: MemberState, teamStrategy: TeamStrategy, emailVerified: boolean, lastAdminNote?: string | null, totalIntroducers: number, signUpPaymentType?: string | null, placementRequested: boolean }> | null } };
