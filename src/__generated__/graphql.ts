...
export type CreatePackageInput = {
  ...
  freePeriodFrom?: InputMaybe<Scalars['DateTimeISO']['input']>;
  freePeriodTo?: InputMaybe<Scalars['DateTimeISO']['input']>;
...
export type Package = {
  ...
  deletedAt?: Maybe<Scalars['DateTimeISO']['output']>;
  freePeriodFrom: Scalars['DateTimeISO']['output'];
  freePeriodTo: Scalars['DateTimeISO']['output'];
  id: Scalars['ID']['output'];
