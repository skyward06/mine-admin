...
export type BalancesQuery = { __typename?: 'Query', balances: { __typename?: 'BalanceResponse', total?: number | null, balances?: Array<{ __typename?: 'Balance', id: string, date: any, type: string, note?: string | null, memberId: string, amountInCents: number, extra1?: string | null, extra2?: string | null, member?: { __typename?: 'Member', id: string, email: string, point: number, mobile: string, status: boolean, balance: number, username: string, fullName: string, groupName: string, allowState: MemberState, teamReport: Array<TeamReport>, OTPEnabled: boolean, teamStrategy: TeamStrategy, syncWithSendy: boolean, emailVerified: boolean, primaryAddress: string, totalIntroducers: number, placementPosition: PlacementPosition, commissionDefault: CommissionDefaultEnum, cmnCalculatedWeeks: number } | null }> | null } };
...
export type AddBalanceMutation = { __typename?: 'Mutation', addBalance: { __typename?: 'Balance', id: string, frontActions?: Array<(
      { __typename?: 'FrontAction' }
...
export type FetchMemberStatsQuery = { __typename?: 'Query', APPROVED: { __typename?: 'MembersResponse', total?: number | null }, PENDING: { __typename?: 'MembersResponse', total?: number | null }, GRAVEYARD: { __typename?: 'MembersResponse', total?: number | null }, PAID: { __typename?: 'MembersResponse', total?: number | null } };
...
export type FetchMembersQuery = { __typename?: 'Query', members: { __typename?: 'MembersResponse', total?: number | null, members?: Array<{ __typename?: 'Member', id: string, ID?: number | null, city?: string | null, email: string, point: number, state?: string | null, status: boolean, avatar?: string | null, mobile: string, assetId?: string | null, balance: number, country?: string | null, zipCode?: string | null, username: string, fullName: string, sponsorId?: string | null, promoCode?: string | null, groupName: string, allowState: MemberState, OTPEnabled: boolean, teamReport: Array<TeamReport>, teamStrategy: TeamStrategy, emailVerified: boolean, syncWithSendy: boolean, primaryAddress: string, preferredContact?: string | null, secondaryAddress?: string | null, totalIntroducers: number, commissionDefault: CommissionDefaultEnum, placementPosition: PlacementPosition, signupFormRequest?: any | null, cmnCalculatedWeeks: number, preferredContactDetail?: string | null, placementParentId?: string | null, createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, commission?: { __typename?: 'CommissionStatus', begL: number, begR: number, newL: number, newR: number } | null, sponsor?: { __typename?: 'Member', id: string, email: string, point: number, mobile: string, status: boolean, balance: number, username: string, fullName: string, groupName: string, allowState: MemberState, teamReport: Array<TeamReport>, OTPEnabled: boolean, teamStrategy: TeamStrategy, syncWithSendy: boolean, emailVerified: boolean, primaryAddress: string, totalIntroducers: number, placementPosition: PlacementPosition, commissionDefault: CommissionDefaultEnum, cmnCalculatedWeeks: number } | null, placementParent?: { __typename?: 'Member', id: string, email: string, point: number, mobile: string, status: boolean, balance: number, username: string, fullName: string, groupName: string, allowState: MemberState, teamReport: Array<TeamReport>, OTPEnabled: boolean, teamStrategy: TeamStrategy, syncWithSendy: boolean, emailVerified: boolean, primaryAddress: string, totalIntroducers: number, placementPosition: PlacementPosition, commissionDefault: CommissionDefaultEnum, cmnCalculatedWeeks: number } | null, placementChildren?: Array<{ __typename?: 'Member', id: string, email: string, point: number, mobile: string, status: boolean, balance: number, username: string, fullName: string, groupName: string, allowState: MemberState, teamReport: Array<TeamReport>, OTPEnabled: boolean, teamStrategy: TeamStrategy, syncWithSendy: boolean, emailVerified: boolean, primaryAddress: string, totalIntroducers: number, placementPosition: PlacementPosition, commissionDefault: CommissionDefaultEnum, cmnCalculatedWeeks: number }> | null, sales?: Array<{ __typename?: 'Sale', id: string, ID: number, memberId: string, packageId: string, isMetal: boolean, paymentMethod: string, sponsorCnt: number, status: boolean, orderedAt: any, proof?: { __typename?: 'Proof', createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, id: string, refId: string, type: ProofType, amount: number, note?: string | null, orderedAt: any, files?: Array<{ __typename?: 'PFile', createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, id: string, url: string, originalName: string, mimeType: string, size: number }> | null, reflinks?: Array<{ __typename?: 'RefLink', linkType: string, link: string }> | null } | null }> | null, memberWallets?: Array<{ __typename?: 'MemberWallet', createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, id: string, memberId: string, payoutId: string, address: string, percent: number, note?: string | null, payout?: { __typename?: 'Payout', id: string, method: string, status: boolean, name: string, display: string, createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null } | null }> | null, logs?: Array<{ __typename?: 'EntityLog', id: string, who: string, role: string, when: any, entity: string, action: string, status: string, before?: any | null, after?: any | null }> | null, adminNotes?: Array<{ __typename?: 'AdminNotes', id: string, adminId: string, memberId: string, updatedAt?: any | null, description?: string | null }> | null }> | null } };

export type IndividualMembersQueryVariables = Exact<{ [key: string]: never; }>;


export type IndividualMembersQuery = { __typename?: 'Query', individualMembers: Array<{ __typename?: 'IndividualMember', id: string, email: string, username: string, fullName: string, createdAt: any, sponsorUsername?: string | null, sponsorFullname?: string | null }> };
...
export type RolesQuery = { __typename?: 'Query', roles: { __typename?: 'RoleResponse', total?: number | null, roles?: Array<{ __typename?: 'Role', id: string, name: string, sale: number, role: number, commission: number, description: string, frontActions?: Array<(
        { __typename?: 'FrontAction' }
        & { ' $fragmentRefs'?: { 'FrontActionFieldsFragment': FrontActionFieldsFragment } }
      )> | null }> | null } };
...
export type RoleByIdQuery = { __typename?: 'Query', roleById: { __typename?: 'Role', id: string, name: string, sale: number, role: number, commission: number, description: string, frontActions?: Array<(
      { __typename?: 'FrontAction' }
      & { ' $fragmentRefs'?: { 'FrontActionFieldsFragment': FrontActionFieldsFragment } }
    )> | null } };
...
export type FetchUserQuery = { __typename?: 'Query', admins: { __typename?: 'AdminsResponse', admins?: Array<{ __typename?: 'Admin', id: string, email: string, avatar: string, roleId: string, username: string, fullName: string, deletedAt?: any | null, OTPEnabled: boolean }> | null } };
...
export type FetchUsersQuery = { __typename?: 'Query', admins: { __typename?: 'AdminsResponse', total?: number | null, admins?: Array<{ __typename?: 'Admin', id: string, email: string, avatar: string, roleId: string, username: string, fullName: string, createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, OTPEnabled: boolean }> | null } };
