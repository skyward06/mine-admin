...
export type WeeklyCommissionByIdQuery = { __typename?: 'Query', weeklyCommissionById: { __typename?: 'WeeklyCommission', createdAt?: any | null, updatedAt?: any | null, deletedAt?: any | null, id: string, ID: number, memberId: string, weekStartDate: any, begL: number, begR: number, newL: number, newR: number, maxL: number, maxR: number, endL: number, endR: number, pkgL: number, pkgR: number, commission: number, shortNote?: string | null, status: ConfirmationStatus, member?: { __typename?: 'Member', username: string, fullName: string, updatedAt?: any | null } | null, proof?: { __typename?: 'Proof', note?: string | null, reflinks?: Array<{ __typename?: 'RefLink', link: string, linkType: string }> | null, files?: Array<{ __typename?: 'PFile', id: string, url: string, size: number, mimeType: string, originalName: string }> | null } | null } };
