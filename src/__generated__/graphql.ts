...
export type MembersQuery = { __typename?: 'Query', members: { __typename?: 'BasicMemberResponse', total?: number | null, members?: Array<{ __typename?: 'BasicMember', id: string, ID?: number | null, city?: string | null, state?: string | null, email: string, status: boolean, mobile: string, zipCode?: string | null, assetId?: string | null, username: string, fullName: string, createdAt: any, allowState: MemberState, teamStrategy: TeamStrategy, adminUsername?: string | null, adminFullname?: string | null, emailVerified: boolean, lastAdminNote?: string | null, primaryAddress: string, secondaryAddress?: string | null, totalIntroducers: number, signUpPaymentType?: string | null, placementRequested: boolean }> | null } };
