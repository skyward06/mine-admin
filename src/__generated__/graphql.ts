...
export type CreateSaleMutation = { __typename?: 'Mutation', createSale: { __typename?: 'Sale', status: boolean, memberId: string, invoiceNo: number, orderedAt: any, packageId: string, paymentMethod: string } };
